...
/// the relay's precompute table turns over rarely. The relay accepts the current AND previous
/// epoch to absorb clock skew and epoch-boundary transit.
...
fn stamp_message(bundle_id: &BundleId, epoch: u64) -> Vec<u8> {
